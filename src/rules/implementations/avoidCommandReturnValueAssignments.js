...
exports.avoidCommandReturnValueAssignments = void 0;
const ts = __importStar(require("typescript"));
function avoidCommandReturnValueAssignments(node) {
    const violations = [];
...
exports.avoidCommandReturnValueAssignments = avoidCommandReturnValueAssignments;
